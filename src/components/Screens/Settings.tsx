      ...
      <div id="setting-panel" ref={targetEle}>
        <div id="avatar-setting">
          <div>
            <img
              id="avatar"
              src={photoUrl ? photoUrl : auth?.user.photo}
              alt="avatar"
            />
          ...
          <div id="themes">
            {Object.keys(allTheme).map((key) => {
                return (
                    ...
                    onClick={() => {
                      //@ts-ignore
                    setTheme(allTheme[key]);
                    changeTheme(key);
                  }}
                  className={`themesquare ${
                    chosenTheme === key.toLowerCase() ? "activeTheme" : ""
                  }`}
                >
                  <div
                    style={{
        ...
        <button className="cbtn cancel" onClick={() => history.push("/")}>
          Back
        </button>
      </div>
    </>
